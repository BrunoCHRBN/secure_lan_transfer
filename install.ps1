...
Write-Host "  ${cEmerald}│${cReset}  ${cDim}🛡️  Criptografia:${cReset}   ${cEmerald}X25519 • ChaCha20-Poly1305 • Zero-Metadata${cReset}"
Write-Host "  ${cEmerald}│${cReset}  ${cDim}🌐 Web & Mobile:${cReset}   ${cCyan}https://secure-lan-transfer.vercel.app${cReset}"
Write-Host "  ${cEmerald}├─────────────────────────────────────────────────────────────┤${cReset}"
